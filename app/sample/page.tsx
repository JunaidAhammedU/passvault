            ...
            >
              {isCopied ? (
                <>
                  ...
                  <TbClipboardCheck className="text-3xl text-[#7756ee] -rotate-12" />
                </>
              ) : (
        ...
        <div>
          <div>
            ...
            <Slider
              ...
              className="w-full mt-2 bg-purple-800 mb-6"
            />
          </div>
              ...
              >
                <Checkbox
                  ...
                  className={`ml-5 rounded-xl  h-[30px] w-[30px] bg-white ${
                    data.state ? " border border-[#7756ee]" : ""
                  }`}
                />
